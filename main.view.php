<div class="main-page">
    ...
    <div class="brand-section__bestsellers-title  clearfix">
      <h3>Bestsellers:</h3>
      <a class="brand-section__btn  btn" href="index.php?pid=catalog&pid=brands&bid=samsung">Samsung Series</a>
    </div>	 
    <ul class="catalog">
        <?php
          foreach ($samsungItems as $product) :						
            $id = $product->id;
			  ?>				
        <li class="catalog__item">
          ...
          <h3 class="catalog__item-title"><?= $product->brandTitle . "<span> " . $product->title . "</span>"?></h3>
          ...
          <div class="catalog__buy-item">                  
            ...
            <a class="catalog__details-btn  btn" href="<?=$m_page_cat_url.$product->title?>"><span>Details</span></a>						
          </div>  
        </li>  
        <?php
					endforeach;
    ...
    <div class="brand-section__bestsellers-title  clearfix">
      <h3>Bestsellers:</h3>
      <a class="brand-section__btn  btn" href="index.php?pid=catalog&pid=brands&bid=lg">LG Series</a>
    </div>
    <ul class="catalog">
        <?php
          foreach ($lgItems as $product) :
            $id = $product->id;
        ?>
        <li class="catalog__item">
          <div class="catalog__image-container  catalog__image-container--small">
