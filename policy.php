	...
	<section class="content__section">
		<div class="content__container">
			...
			<p class="content__paragraph">
				This privacy policy is for this website and served by URMEDIA and governs the privacy of its users who choose to use it.
			</p>
			<p class="content__paragraph">	
...
<!--http://jamieking.co.uk/resources/download-free-sample-privacy-policy.html-->